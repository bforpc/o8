<!-- Feather Icons 4.29.2; MIT; Copyright (c) 2013-2023 Cole Bemis.
     Pinned source and hashes: public/assets/vendor/feather/provenance.json.
     Original geometry retained for the Feather symbols; SVG wrappers adapted to symbols and local CSS.
     i-tag is an o8 project symbol, drawn for the M2 document list. -->
<svg class="icon-library" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <symbol id="i-document" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></symbol>
    ...
    <symbol id="i-tag" viewBox="0 0 24 24"><path d="M20.59 13.41 13 21H4a1 1 0 0 1-1-1v-9l7.59-7.59a2 2 0 0 1 1.42-.59H20a1 1 0 0 1 1 1v7.99a2 2 0 0 1-.41 1.6z"/><circle cx="16.5" cy="7.5" r="1.5"/></symbol>
    ...
    <symbol id="i-arrow" viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></symbol>
