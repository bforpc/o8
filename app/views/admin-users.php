...
<article class="border rounded p-3 mb-3" data-user-id="<?= h($user['id']) ?>">
...
<details><summary>Benutzer bearbeiten</summary><form method="post" class="mt-3"><?php postFields('user_update','users'); ?>
