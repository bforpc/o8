-- ENTWURF M1. Nicht ausgeführt. Engine-/Versionsprüfung und vollständige
-- Inventarisierung aller o7-Felder erfolgen vor Freigabe der Migration in M2/M5.
-- Eine separate o8-Datenbank wird später explizit konfiguriert.
-- Rechte-/Settings-Vertrag: docs/SETTINGS_AND_PERMISSIONS.md.


-- Mandanten-ID ist Teil ALLER fachlichen Fremdschlüssel. Keine Cross-Tenant-Links.
-- UUID für externe Identifikation/Lizenz, interne BIGINT für Indizes.
...
CREATE TABLE accounting_vat_rates (
    tenant_id BIGINT UNSIGNED NOT NULL,
    rate DECIMAL(5,2),
    active BOOLEAN NOT NULL DEFAULT TRUE,
